...
<head>
    ...
    <title>HomelyHeart - Service Seeker Home Page</title>
...
<body>
    ...
    <!-- Main Section -->
    <section class="hero">
        <h1>Welcome to Home&Heart</h1>
        <p>Your connection to trusted service providers</p>
        <a href="ssservicespage.php" class="cta-btn">Find a Service</a>
    </section>

    <div class="image-container">
        <img src="spservice.png" alt="Service Image">
    </div>

    <h2 style="color: white; font-size: 24px; font-weight: bold; text-align: center;">
        Meet Our Trusted House - Helps!
    </h2>
    <!-- Profiles Section -->
    <section class="profiles">
        <div class="profile">
            <img src="maid1.jpg" alt="Maid 1">
            <h3>Kamla Paswan</h3>
            <p>5 years of experience</p>
        </div>
        <div class="profile">
            <img src="maid2.jpg" alt="Maid 2">
            <h3>Munna Tiwari</h3>
            <p>3 years of experience</p>
        </div>
        <div class="profile">
            <img src="maid3.jpg" alt="Maid 3">
            <h3>Suman Yadav</h3>
    ...
    <section class="info">
        <h2>How It Works ?</h2>
        <img src="sshowitworks.jpg" alt="How It Works Image">
    </section>

    <!-- What We Offer -->
    <section class="info">
        <h2>What We Offer ?</h2>
        <img src="sswhatweoffer.jpg" alt="What We Offer Image">
    </section>

    <!-- Why Choose Us -->
    <section class="info">
        <h2>Why Choose Us ?</h2>
        <img src="sswhychooseus.jpg" alt="Why Choose Us Image">
    </section>
    ...
    <section class="info">
        ...
        <div class="client-reviews">
            <div class="client-review">
                ...
                <h3>Mamta Srivastava</h3>
                <p>Excellent service, very professional!</p>
            </div>
            <div class="client-review">
                <img src="client2.jpg" alt="Client 2">
                <h3>Pankaj Mishra</h3>
                <p>Very satisfied with the service provided.</p>
            </div>
            <div class="client-review">
                <img src="client3.jpg" alt="Client 3">
                <h3>Anita Jaiswal</h3>
                <p>Highly recommend, great experience!</p>
            </div>
            <div class="client-review">
            ...
            <div class="client-review">
                ...
                <h3>Meenakshi Bhardwaj</h3>
                <p>Very happy with the service.</p>
            </div>
            <div class="client-review">
                <img src="client6.jpg" alt="Client 6">
                <h3>Rajesh Tripathi</h3>
                <p>Great service, will use again.</p>
            </div>
            <div class="client-review">
            ...
            <div class="client-review">
                <img src="client9.jpg" alt="Client 9">
                <h3>Neelam Patel</h3>
    ...
    <section class="info">
        ...
        <div class="faq">
            <div class="question">1. How do I book a Service Provider ?</div>
            <div class="answer">After completing your Profile, Browse available Service Provider, Select one, Choose a time slot, and Send a booking request.</div>
        </div>
        <div class="faq">
            <div class="question">2. How does the payment system work ?</div>
            <div class="answer">To confirm a booking, you need to pay 10% of the total amount to Home&Heart. The
                remaining 90% is paid in cash directly to the Service Provider after service completion.</div>
        </div>
        <div class="faq">
            <div class="question">3. Can I post my own service request ?</div>
            <div class="answer">Yes, you can post a request with your budget and preferred days; You will get contacted then.</div>
        </div>
        <div class="faq">
            <div class="question">4. How do I find the right Service Provider for my needs ?</div>
            <div class="answer">You can search, filter, and sort Service Providers based on service type, price,
                to find the most suitable provider.</div>
        </div>
        <div class="faq">
            <div class="question">5. How will I know the status of my booking?</div>
            <div class="answer">You’ll receive notifications for every update like request, booking confirmation.</div>
        </div>
    </section>
    <!-- Back to Top -->
